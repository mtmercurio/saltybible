...
extension Reading {
    ...
    [
        DailyReading(month: 1, day: 1, readings: [
            Reading(title: "Matthew 1:1-17", group: "NT1", hasRead: false, tags: ["NT", "Gospel"]),
            Reading(title: "Acts 1:1-11", group: "NT2", hasRead: false, tags: ["NT", "Gospel"]),
            Reading(title: "Psalms 1", group: "OT1", hasRead: false, tags: ["OT"]),
            Reading(title: "Genesis 1-2", group: "OT2", hasRead: false, tags: ["OT"])
        ]),
        DailyReading(month: 1, day: 2, readings: [
            Reading(title: "Matthew 1:18-25", group: "NT1", hasRead: false, tags: ["NT", "Gospel"]),
            Reading(title: "Acts 1:12-26", group: "NT2", hasRead: false, tags: ["NT", "Gospel"]),
            Reading(title: "Psalms 2", group: "OT1", hasRead: false, tags: ["OT"]),
            Reading(title: "Genesis 3-4", group: "OT2", hasRead: false, tags: ["OT"])
        ]),
        DailyReading(month: 1, day: 3, readings: [
